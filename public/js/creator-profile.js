...
<div class="profile-container">
    ...
    <h2 class="profile-username">@{{ $creator->username }} 
        ...
        @endif
        <span class="online-badge" style="background: #2ecc71; width: 10px; height: 10px; border-radius: 50%; display: inline-block; margin-left: 8px;" title="Online Agora"></span>
    </h2>
    ...
    <!-- Adicione estes badges sociais -->
    <div class="social-badges" style="display: flex; gap: 0.5rem; margin-top: 1rem;">
        <a href="#" style="font-size: 1.2rem; color: rgba(255,255,255,0.7); transition: color 0.3s;" title="Instagram">
        ...
        <a href="#" style="font-size: 1.2rem; color: rgba(255,255,255,0.7); transition: color 0.3s;" title="Twitter">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path>
            </svg>
        </a>
        <a href="#" style="font-size: 1.2rem; color: rgba(255,255,255,0.7); transition: color 0.3s;" title="TikTok">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
