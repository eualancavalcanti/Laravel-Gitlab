...
Route::get('/pay-per-view', [App\Http\Controllers\PayPerViewController::class, 'index'])->name('pay-per-view.index');
...
Route::get('/api/planos/principais', [PlanoController::class, 'getPrincipais'])->name('api.plans.main');